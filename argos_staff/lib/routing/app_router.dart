    ...
    switch (settings.name) {
      ...
      case AppRoutes.dispatch:
        return _buildRoute(
          ...
          child: const OpsPlaceholderPage(
            selectedTab: StaffTab.dispatch,
            title: 'Dispatch Queue',
            subtitle: 'Incoming triage and unit assignment will appear here.',
      ...
      case AppRoutes.response:
        return _buildRoute(
          ...
          child: const OpsPlaceholderPage(
            selectedTab: StaffTab.response,
            title: 'Response Board',
            subtitle: 'Track active teams and live response telemetry.',
